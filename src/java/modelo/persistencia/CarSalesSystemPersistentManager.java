...
public class CarSalesSystemPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "CarSalesSystem";
	...
	private CarSalesSystemPersistentManager() throws PersistentException {
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(modelo.persistencia.Empleado.class);
		configuration.addAnnotatedClass(modelo.persistencia.Vehiculo.class);
		configuration.addAnnotatedClass(modelo.persistencia.Reservador.class);
		configuration.addAnnotatedClass(modelo.persistencia.Venta.class);
		configuration.addAnnotatedClass(modelo.persistencia.Imagen.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new CarSalesSystemPersistentManager();
		}
