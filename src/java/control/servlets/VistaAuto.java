 ...
 * @author edisonarango
 */
@WebServlet(name = "VistaAuto", urlPatterns = {"/VistaAuto"})
public class VistaAuto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vehiculo==null) {
            ...
            if (tipo!=null && tipo.equals("slider")) {
                request.getRequestDispatcher("vista/principal/slider.jsp").forward(request, response);
            }
            else{
                request.getRequestDispatcher("vista/vistaAuto.jsp").forward(request, response);
            }
